...
namespace airlib
{
    ...
    public:
        ...
        void initWindModule(const std::string dataPath, const float updateInterval, const msr::airlib::Vector3r& defaultWind, const bool logEnable) override
        {
    ...
    private:
        ...
        void updatePhysics(PhysicsBody& body)
        {
            ...
            getNextKinematicsNoCollision(dt, body, current, next, next_wrench, windManager->getLocalWind(body.getPose().position));
        ...
        */
        ...
        static Wrench getDragWrench(const PhysicsBody& body, const Quaternionr& orientation,
                                    const Vector3r& linear_vel, const Vector3r& angular_vel_body, const Vector3r& local_wind)
        {
    ...
    private:
        ...
        std::unique_ptr<WindModule> windManager;
    };
}
} //namespace
#endif
